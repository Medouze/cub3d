# Compiler and flags
CC = cc
CFLAGS = -Wall -Wextra -Werror -I $(LIBFT_INC) -g -O3
...
leak: all
	valgrind --leak-check=full --show-leak-kinds=all ./$(NAME) maps/corridor.cub
